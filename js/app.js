...
// ── Ilustraciones por estado (v2.2) ──
const ESTADO_ILLUS = {
  'piscina':         'assets/illustrations/Resolucion/Estados/V2.1/01-Piscina.png',
  'muy-agradable':   'assets/illustrations/Resolucion/Estados/V2.1/02-MuyAgradable.png',
  'se-puede-salir':  'assets/illustrations/Resolucion/Estados/V2.1/03-Sepuedesalir.png',
  'exigente':        'assets/illustrations/Resolucion/Estados/V2.1/04-Exigente.png',
  'no-recomendable': 'assets/illustrations/Resolucion/Estados/V2.1/05-No.png',
};
...
const WARN_SVG = `<svg class="tech-state-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M4.47 21h15.06c1.54 0 2.5-1.67 1.73-3L13.73 4c-.77-1.33-2.69-1.33-3.46 0L2.74 18c-.77 1.33.19 3 1.73 3zM12 14c-.55 0-1-.45-1-1v-2c0-.55.45-1 1-1s1 .45 1 1v2c0 .55-.45 1-1 1zm1 4h-2v-2h2v2z"/></svg>`;
...
function renderTechBlocks(d, warnings) {
  ...
  const windDirCat = currentSpot?.offshore_range ? windDirCategory(d.windDir, currentSpot) : -1;
  const windDirLabel = windDirCat === 0 ? 'Onshore' : windDirCat === 1 ? 'Offshore' : windDirCat === 2 ? 'Lateral' : null;
        ...
        <div class="tech-card tech-card--full" data-info="wind-direction">
          ...
          <div class="tech-cell__dir-body">
            <div>
              ...
              ${windDirLabel ? `<div class="tech-cell__sub">${windDirLabel}</div>` : ''}
            </div>
